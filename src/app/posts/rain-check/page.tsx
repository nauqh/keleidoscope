...
const paragraphs = [
	"Rain Check is a contemporary theatre piece that gives form to the quiet things we often leave unsaid. Every character, in their own way, embodies the concept of taking a rain check. The play explores that idea through blurred relational boundaries, intergenerational trauma and the murky grey areas of emotional life. It does so with empathy, but not with easy answers.",
